...
public class activity_post_3 extends AppCompatActivity {
    ...
    private void writeNewBoard(String title, String content) {
        Board_1 board = new Board_1(title, content);
        mDatabase.child("boards_3").push().setValue(board)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        // Write was successful!
                        Toast.makeText(activity_post_3.this, "게시물이 작성 되었습니다", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        // Write failed
                        Toast.makeText(activity_post_3.this,  "save faulure", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
