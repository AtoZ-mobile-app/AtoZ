...
public class activity_post_1 extends AppCompatActivity {
    ...
    private void writeNewBoard(String title, String content) {
        ...
        mDatabase.child("boards_1").push().setValue(board)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        // Write was successful!
                        Toast.makeText(activity_post_1.this, "게시물이 작성 되었습니다", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        // Write failed
                        Toast.makeText(activity_post_1.this,  "save faulure", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
