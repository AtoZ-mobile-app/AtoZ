...
public class AllContentOutputActivity2 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_all_content_output2);
        setTitle("전체 출력 보기");
        ...
        allList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener()
        {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id)
            {
                ...
                {
                    updated = false;
                    AlertDialog.Builder dlg = new AlertDialog.Builder(AllContentOutputActivity2.this);
                    dlg.setTitle("데이터 삭제");
    ...
    public void insertData(String [] str)
    {
        ...
        sqlDB = dbHelper2.getWritableDatabase();
        try
        {
    ...
    public void setModifyDialogue(final int position)
    {
        ...
        {
            deleted = false;
            modifyDialogue = (View) View.inflate(AllContentOutputActivity2.this, R.layout.dialogue1, null);
            AlertDialog.Builder dlg = new AlertDialog.Builder(AllContentOutputActivity2.this);
            dlg.setTitle("데이터 수정");
    ...
    {
        addDialogue = (View)View.inflate(AllContentOutputActivity2.this,R.layout.dialogue,null);
        AlertDialog.Builder dlg = new AlertDialog.Builder(AllContentOutputActivity2.this);
        dlg.setTitle("데이터 입력");
