...
public class AllContentOutputActivity1 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_all_content_output1);
        setTitle("전체 출력 보기");
        ...
        allList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener()
        {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id)
            {
                ...
                {
                    updated = false;
                    AlertDialog.Builder dlg = new AlertDialog.Builder(AllContentOutputActivity1.this);
                    dlg.setTitle("데이터 삭제");
                    dlg.setMessage("데이터를 삭제하시면 되돌릴 수 없습니다.");
                    dlg.setIcon(R.drawable.temp);
    ...
    public void init()
    {
        ...
        sqlDB = dbHelper1.getReadableDatabase();
        Cursor cursor;
    ...
    public void insertData(String [] str)
    {
        ...
        sqlDB = dbHelper1.getWritableDatabase();
        try
        {
    ...
    public void setModifyDialogue(final int position)
    {
        ...
        {
            deleted = false;
            modifyDialogue = (View) View.inflate(AllContentOutputActivity1.this, R.layout.dialogue1, null);
            AlertDialog.Builder dlg = new AlertDialog.Builder(AllContentOutputActivity1.this);
            dlg.setTitle("데이터 수정");
    ...
    {
        addDialogue = (View)View.inflate(AllContentOutputActivity1.this,R.layout.dialogue,null);
        AlertDialog.Builder dlg = new AlertDialog.Builder(AllContentOutputActivity1.this);
        dlg.setTitle("데이터 입력");
        ...
        public void onClick(View v)
        {
            switch(v.getId())
            {
                ...
                case R.id.allBackBtn:
                    intent = new Intent(getApplicationContext(),NowMonthInputActivity1.class);
